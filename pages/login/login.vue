...
export default {
	...
	methods: {
		...
		onLogin() {
			console.log('login');
			uni.request({
			    //url: 'http://169.254.192.3:4001/provider/feign/hello2', //仅为示例，并非真实接口地址。
			    url: 'http://169.254.192.3:4001/consumer/hello1', //仅为示例，并非真实接口地址。
			    //url: 'http://169.254.192.3:9001/login', //仅为示例，并非真实接口地址。
